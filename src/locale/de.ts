...
export const de: Record<string, string> = {
  ...
  "Bring forward": "Eine Ebene nach vorn",
  ...
  "Added {n} layers": "{n} Ebenen hinzugefügt",
  "Removed \u201c{name}\u201d": "\u201e{name}\u201c entfernt",
  "Removed {n} layers": "{n} Ebenen entfernt",
  "Replaced layers": "Ebenen ersetzt",
  "Reordered layers": "Ebenen umsortiert",
  "Changed {n} layers": "{n} Ebenen geändert",
  "Renamed to \u201c{name}\u201d": "Umbenannt in \u201e{name}\u201c",
  "Showed \u201c{name}\u201d": "\u201e{name}\u201c eingeblendet",
  "Hid \u201c{name}\u201d": "\u201e{name}\u201c ausgeblendet",
  "Locked \u201c{name}\u201d": "\u201e{name}\u201c gesperrt",
  "Unlocked \u201c{name}\u201d": "\u201e{name}\u201c entsperrt",
  "Edited text of \u201c{name}\u201d": "Text von \u201e{name}\u201c bearbeitet",
  "Rotated \u201c{name}\u201d": "\u201e{name}\u201c gedreht",
  "Opacity of \u201c{name}\u201d": "Deckkraft von \u201e{name}\u201c",
  "Swapped image of \u201c{name}\u201d": "Bild von \u201e{name}\u201c getauscht",
  "Moved \u201c{name}\u201d": "\u201e{name}\u201c verschoben",
  "Resized \u201c{name}\u201d": "\u201e{name}\u201c skaliert",
  "Changed \u201c{name}\u201d": "\u201e{name}\u201c geändert",
  "Added the back side": "Rückseite hinzugefügt",
  "Removed the back side": "Rückseite entfernt",
  "Other change": "Sonstige Änderung",
  "Align to card": "An der Karte ausrichten",
  Left: "Links",
  Right: "Rechts",
  Top: "Oben",
  Middle: "Mitte",
  ...
  "Your own logo files, kept in this browser and shared by every project. With \u201cLogo source: Local\u201d the logo search matches them by file name \u2014 name each file after its console (\u201cSuper Nintendo.png\u201d), folders are fine too.":
    "Deine eigenen Logo-Dateien, gespeichert in diesem Browser und für alle Projekte gemeinsam. Mit \u201eLogo-Quelle: Lokal\u201c findet die Logo-Suche sie über den Dateinamen \u2013 benenne jede Datei nach ihrer Konsole (\u201eSuper Nintendo.png\u201c), Ordner sind auch in Ordnung.",
  "Drop logos, folders or a .zip here": "Logos, Ordner oder eine .zip hier ablegen",
  "Add files or .zip \u2026": "Dateien oder .zip hinzufügen \u2026",
  "Add folder \u2026": "Ordner hinzufügen \u2026",
  "{added} added, {replaced} replaced, {skipped} skipped.": "{added} hinzugefügt, {replaced} ersetzt, {skipped} übersprungen.",
  "Remove all {n} logos?": "Alle {n} Logos entfernen?",
  "Remove all": "Alle entfernen",
  "Cards that already use one of them keep their copy.": "Karten, die eines davon schon verwenden, behalten ihre Kopie.",
  "No logos yet.": "Noch keine Logos.",
  ...
  "None of your logos matches \u201c{title}\u201d. Try another search term, or add files under Settings \u25b8 Manage logos \u2026":
    "Keines deiner Logos passt zu \u201e{title}\u201c. Probiere einen anderen Suchbegriff oder füge Dateien unter Einstellungen \u25b8 Logos verwalten \u2026 hinzu.",
  "More details": "Weitere Details",
  "Age rating": "Altersfreigabe",
  "Collection / series": "Reihe / Serie",
  "Series / franchise": "Serie / Franchise",
  ...
  Website: "Webseite",
  Votes: "Stimmen",
  "e.g. FSK 12": "z. B. FSK 12",
  "e.g. PEGI 12": "z. B. PEGI 12",
  "Shows this value from the card's metadata; nothing is drawn where the entry has none.":
    "Zeigt diesen Wert aus den Metadaten der Karte; fehlt er im Eintrag, wird nichts gezeichnet.",
  ...
  Undo: "Rückgängig",
  Redo: "Wiederholen",
  "Show / hide bleed": "Beschnitt ein-/ausblenden",
  "Show / hide guides": "Hilfslinien ein-/ausblenden",
  "Open the 3D preview": "3D-Vorschau öffnen",
  "This overview": "Diese Übersicht",
  "Selected layer": "Ausgewählte Ebene",
  "Move up / down in the stack": "Im Stapel nach oben / unten",
  "Nudge by 1 px (⇧: 10 px)": "Um 1 px verschieben (⇧: 10 px)",
  Deselect: "Auswahl aufheben",
  "Spin by 45°": "Um 45° drehen",
  "Flip to the back": "Auf die Rückseite drehen",
  ...
  "QR code": "QR-Code",
  "Content (URL or text)": "Inhalt (URL oder Text)",
  Modules: "Module",
  "Draw background (quiet zone)": "Hintergrund zeichnen (Ruhezone)",
  "Error correction": "Fehlerkorrektur",
  "Low (7 %)": "Niedrig (7 %)",
  "Medium (15 %)": "Mittel (15 %)",
  "Quartile (25 %)": "Quartil (25 %)",
  "High (30 %)": "Hoch (30 %)",
  "Higher levels survive more damage but need more modules. Keep the code at least 15 mm wide for a phone to read it.":
    "Höhere Stufen vertragen mehr Beschädigung, brauchen aber mehr Module. Für Smartphones den Code mindestens 15 mm breit lassen.",
  ...
  "From the template (console, else global)": "Aus der Vorlage (Konsole, sonst global)",
  "Neither template has a background yet.": "Noch keine Vorlage hat einen Hintergrund",
